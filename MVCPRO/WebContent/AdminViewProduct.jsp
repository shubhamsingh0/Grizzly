      ...
      <div class="row">
        <div class="col-md-3 bg-light">
          ...
          <center>
            ...
            <br>
            <br>
            <b>&nbsp&nbsp&nbsp&nbsp${sessionScope.username}
            </b>
            <br>
            <br>
            ID:
          ...
          <div class="container">
            ...
            <div class="tab-content">
              <div id="home" class="container tab-pane active">
                ...
                <p>
                  <b>${SessionScope.pname}
                  </b> by ${SessionScope.pbrand}
                  <a href="">
                    <span class="fa fa-pencil-square">
                    </span>
                  </a>
                  <br>
                  <span class="fa fa-star">&nbsp;4.7
                  </span>
                <div class="row">
                  ...
                  <div class="col-md-4 ">
                    ...
                    <div class="form-group">
                      <br>
                      <textarea rows="5" id="comment" readonly>Description
                      </textarea>
                    </div>
                  </div>
                </div>
